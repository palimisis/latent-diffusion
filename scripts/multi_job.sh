...
if [ -z $1 ]; then
    ...
    sbatch -J $jid -o "${STDOUT}.out" -e "${STDOUT}.err" /home/it21902/latent-diffusion/scripts/job.sh --base configs/latent-diffusion/sixray.yaml -t --gpus 0, --resume /home/it21902/latent-diffusion/logs/2024-03-20T15-41-49_sixray
...
for ((i=1; i<${N_STEPS}; i++)); do
    ...
    sbatch -J $jid -o "${STDOUT}.out" -e "${STDOUT}.err" -d afterany:${depends} /home/it21902/latent-diffusion/scripts/job.sh --base configs/latent-diffusion/sixray.yaml -t --gpus 0, --resume /home/it21902/latent-diffusion/logs/2024-03-20T15-41-49_sixray 
    echo $tot_epochs > ${CHK_EPOCHS}.numepochs
done
